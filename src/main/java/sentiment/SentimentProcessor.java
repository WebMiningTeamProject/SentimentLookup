...
/**
 * A class for assigning sentiments to texts.
 */
public class SentimentProcessor {

    /**
     * This method will calculate a lookup-based sentiment score for the given text.
     * @param text The text for which the sentiment shall be calculated.
     * @return The sentiment score for the given text. The score ranges from -1.0 to 1.0.
     */
    public static double getSentiment(String text){
        ...
        for(String token : bow){
            ...
            // reduce granularity (POS tagger is too detailed for look-up mechanism)
            token = token
